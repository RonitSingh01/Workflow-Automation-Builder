...
//     // executorService returns runId
//     const runId = await executorService.executeWorkflow(workflowId, req.user);
...
//     const logs = await executorService.getRunDetails(runId, req.user);
//     res.json(logs);
//   } catch (err) { next(err); }
// };
// src/controllers/executionController.js
